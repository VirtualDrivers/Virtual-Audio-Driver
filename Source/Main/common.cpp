    ...
    public CUnknown    
{
    ...
    public:
        ...
        STDMETHODIMP_(LONG)     EqualizerBandRead
        (
            _In_  ULONG           Index,
            _In_  ULONG           Band
        );

        STDMETHODIMP_(void)     EqualizerBandWrite
        (
            _In_  ULONG           Index,
            _In_  ULONG           Band,
            _In_  LONG            Value
        ...
        // Noise Suppression
        STDMETHODIMP_(BOOL)     NoiseSuppressionEnabledRead
        (
            _In_  ULONG           Index
        );

        STDMETHODIMP_(void)     NoiseSuppressionEnabledWrite
        (
            _In_  ULONG           Index,
            _In_  BOOL            Value
        );

        STDMETHODIMP_(LONG)     NoiseSuppressionLevelRead
        (
            _In_  ULONG           Index
        );

        STDMETHODIMP_(void)     NoiseSuppressionLevelWrite
        (
            _In_  ULONG           Index,
            _In_  LONG            Value
        );
        ...
        STDMETHODIMP_(BOOL)     AgcEnabledRead
        (
            _In_  ULONG           Index
        );

        STDMETHODIMP_(void)     AgcEnabledWrite
        (
            _In_  ULONG           Index,
            _In_  BOOL            Value
        );

        STDMETHODIMP_(LONG)     AgcLevelRead
        (
            _In_  ULONG           Index
        );

        STDMETHODIMP_(void)     AgcLevelWrite
        (
            _In_  ULONG           Index,
            _In_  LONG            Value
        );
...
#pragma code_seg("PAGE")
STDMETHODIMP_(LONG)
CAdapterCommon::EqualizerBandRead
( 
    _In_  ULONG                   Index,
    _In_  ULONG                   Band
)
{
    ...
    if (m_pHW)
    {
        return m_pHW->GetEqualizerBand(Index, Band);
    }
...
STDMETHODIMP_(void)
CAdapterCommon::EqualizerBandWrite
( 
    _In_  ULONG                   Index,
    _In_  ULONG                   Band,
    _In_  LONG                    Value 
)
{
    ...
    if (m_pHW)
    {
        m_pHW->SetEqualizerBand(Index, Band, Value);
    }
} // EqualizerBandWrite
...
//=============================================================================
STDMETHODIMP_(BOOL)
CAdapterCommon::NoiseSuppressionEnabledRead
(
    _In_  ULONG                   Index
)
{
    ...
    if (m_pHW)
    {
        return m_pHW->GetNoiseSuppressionEnabled(Index);
    }

    return FALSE;
} // NoiseSuppressionEnabledRead

STDMETHODIMP_(void)
CAdapterCommon::NoiseSuppressionEnabledWrite
(
    _In_  ULONG                   Index,
    _In_  BOOL                    Value
)
{
    ...
    if (m_pHW)
    {
        m_pHW->SetNoiseSuppressionEnabled(Index, Value);
    }
} // NoiseSuppressionEnabledWrite

STDMETHODIMP_(LONG)
CAdapterCommon::NoiseSuppressionLevelRead
( 
    _In_  ULONG                   Index
)
{
    ...
    if (m_pHW)
    {
        return m_pHW->GetNoiseSuppressionLevel(Index);
    }

    return 0;
} // NoiseSuppressionLevelRead

STDMETHODIMP_(void)
CAdapterCommon::NoiseSuppressionLevelWrite
( 
    _In_  ULONG                   Index,
    _In_  LONG                    Value 
)
{
    ...
    if (m_pHW)
    {
        m_pHW->SetNoiseSuppressionLevel(Index, Value);
    }
} // NoiseSuppressionLevelWrite

//=============================================================================
// Automatic Gain Control
//=============================================================================
STDMETHODIMP_(BOOL)
CAdapterCommon::AgcEnabledRead
(
    _In_  ULONG                   Index
)
{
    ...
    if (m_pHW)
    {
        return m_pHW->GetAgcEnabled(Index);
    }
...
STDMETHODIMP_(void)
CAdapterCommon::AgcEnabledWrite
(
    _In_  ULONG                   Index,
    _In_  BOOL                    Value
)
{
    ...
    if (m_pHW)
    {
        m_pHW->SetAgcEnabled(Index, Value);
    }
} // AgcEnabledWrite

STDMETHODIMP_(LONG)
CAdapterCommon::AgcLevelRead
( 
    _In_  ULONG                   Index
)
{
    ...
    if (m_pHW)
    {
        return m_pHW->GetAgcLevel(Index);
    }
...
)
{
    ...
    if (NT_SUCCESS(ntStatus))
    {
        if (bEnabled)
        {
            // Guard against mismatched enable calls.
            if (m_dwIdleRequests > 0)
            {
                m_dwIdleRequests--;
