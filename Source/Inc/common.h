...
DECLARE_INTERFACE_(IAdapterCommon, IUnknown)
{
    ...
    STDMETHOD_(LONG,            EqualizerBandRead) 
    ( 
        THIS_ 
        _In_  ULONG               Index,
        _In_  ULONG               Band
    ...
    STDMETHOD_(VOID,            EqualizerBandWrite) 
    ( 
        THIS_ 
        _In_  ULONG               Index,
        _In_  ULONG               Band,
    ...
    // Noise Suppression
    STDMETHOD_(BOOL,            NoiseSuppressionEnabledRead)
    (
        THIS_
        _In_  ULONG               Index
    ) PURE;

    STDMETHOD_(VOID,            NoiseSuppressionEnabledWrite)
    (
        THIS_
        _In_  ULONG               Index,
        _In_  BOOL                Value
    ...
    STDMETHOD_(LONG,            NoiseSuppressionLevelRead) 
    ( 
        THIS_ 
        _In_  ULONG               Index
    ) PURE;

    STDMETHOD_(VOID,            NoiseSuppressionLevelWrite) 
    ( 
        THIS_ 
        _In_  ULONG               Index,
        _In_  LONG                Value 
    ...
    STDMETHOD_(BOOL,            AgcEnabledRead)
    (
        THIS_
        _In_  ULONG               Index
    ) PURE;

    STDMETHOD_(VOID,            AgcEnabledWrite)
    (
        THIS_
        _In_  ULONG               Index,
        _In_  BOOL                Value
    ...
    STDMETHOD_(LONG,            AgcLevelRead) 
    ( 
        THIS_ 
        _In_  ULONG               Index
    ) PURE;

    STDMETHOD_(VOID,            AgcLevelWrite) 
    ( 
        THIS_ 
        _In_  ULONG               Index,
        _In_  LONG                Value 
