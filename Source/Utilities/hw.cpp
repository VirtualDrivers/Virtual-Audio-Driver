...
--*/
{
    ...
    for (ULONG i=0; i<MAX_TOPOLOGY_NODES; ++i)
    {
        ...
        // Initialize equalizer bands to neutral (0 = no boost/cut)
        for (ULONG j = 0; j < MAX_EQUALIZER_BANDS; ++j)
        {
            m_EqualizerBands[i][j] = 0;
        }
        // Initialize noise suppression to disabled
        m_NoiseSuppressionEnabled[i] = FALSE;
        m_NoiseSuppressionLevel[i] = 0;
        // Initialize AGC to disabled
        m_AgcEnabled[i] = FALSE;
        m_AgcLevel[i] = 0;
    }
...
#pragma code_seg("PAGE")
LONG
CVirtualAudioDriverHW::GetEqualizerBand
(
    _In_  ULONG                   ulNode,
    _In_  ULONG                   ulBand
)
{
    ...
    if (ulNode < MAX_TOPOLOGY_NODES && ulBand < MAX_EQUALIZER_BANDS)
    {
        return m_EqualizerBands[ulNode][ulBand];
    }
...
void
CVirtualAudioDriverHW::SetEqualizerBand
(
    _In_  ULONG                   ulNode,
    _In_  ULONG                   ulBand,
    _In_  LONG                    lLevel
)
{
    ...
    if (ulNode < MAX_TOPOLOGY_NODES && ulBand < MAX_EQUALIZER_BANDS)
    {
        m_EqualizerBands[ulNode][ulBand] = lLevel;
    }
} // SetEqualizerBand
...
//=============================================================================
BOOL
CVirtualAudioDriverHW::GetNoiseSuppressionEnabled
(
    _In_  ULONG                   ulNode
)
{
    ...
    if (ulNode < MAX_TOPOLOGY_NODES)
    {
        return m_NoiseSuppressionEnabled[ulNode];
    }
...
void
CVirtualAudioDriverHW::SetNoiseSuppressionEnabled
(
    _In_  ULONG                   ulNode,
    _In_  BOOL                    fEnabled
)
{
    ...
    if (ulNode < MAX_TOPOLOGY_NODES)
    {
        m_NoiseSuppressionEnabled[ulNode] = fEnabled;
    }
} // SetNoiseSuppressionEnabled

LONG
CVirtualAudioDriverHW::GetNoiseSuppressionLevel
(
    _In_  ULONG                   ulNode
)
{
    ...
    if (ulNode < MAX_TOPOLOGY_NODES)
    {
        return m_NoiseSuppressionLevel[ulNode];
    }
...
void
CVirtualAudioDriverHW::SetNoiseSuppressionLevel
(
    _In_  ULONG                   ulNode,
    _In_  LONG                    lLevel
)
{
    ...
    if (ulNode < MAX_TOPOLOGY_NODES)
    {
        m_NoiseSuppressionLevel[ulNode] = lLevel;
    }
...
//=============================================================================
BOOL
CVirtualAudioDriverHW::GetAgcEnabled
(
    _In_  ULONG                   ulNode
)
{
...
void
CVirtualAudioDriverHW::SetAgcEnabled
(
    _In_  ULONG                   ulNode,
    _In_  BOOL                    fEnabled
)
{
    ...
    if (ulNode < MAX_TOPOLOGY_NODES)
    {
        m_AgcEnabled[ulNode] = fEnabled;
    }
} // SetAgcEnabled

LONG
CVirtualAudioDriverHW::GetAgcLevel
(
    _In_  ULONG                   ulNode
)
{
...
void
CVirtualAudioDriverHW::SetAgcLevel
(
    _In_  ULONG                   ulNode,
    _In_  LONG                    lLevel
)
